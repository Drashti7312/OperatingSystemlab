...
function escanImplement(){
    ...
    if (DirectionSelec === "largerValue"){
        ...
        var AlgoGraph = new Chart(grf, {
            type: 'line',
            data: {
                labels: scanAlgo3Large(Queue_vals, Head_position),
                datasets: [
                    {
    ...
    if(DirectionSelec==="lowerValue"){
        ...
        var AlgoGraph = new Chart(grf, {
            type: 'line',
            data: {
                labels: scanAlgo3Lower(Queue_vals, Head_position),
                datasets: [
                    {
                        backgroundColor: "rgba(1,1,1,0.8)",
                        borderColor: "rgba(0,0,0,0.3)",
...
function Result(count, seekSequence)
{
    ...
    else div.innerHTML = "<br/>Seek Sequence: <b>[" + seekSequence + "]</b><br><br>Total Seek Count: <b>" + count + "<b><u>";
}